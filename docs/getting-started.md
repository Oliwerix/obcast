...
| `OBCAST_PLAYOUT_RING_SEGMENTS` | `8`      | how many segments deep the playout engine decodes ahead of real-time output; higher = more resilience to a transient decode/disk slowdown at the cost of more ingest-to-audible latency |
